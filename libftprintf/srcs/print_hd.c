...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/10/13 12:28:39 by mdos-san          #+#    #+#             */
/*   Updated: 2016/10/22 06:08:18 by mdos-san         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	get_width(t_flag *flag, char *arr, int *nb, short in)
{
	*nb = 0;
...
static void	flag_space(t_flag *flag, short in, int *nb, int *r)
{
...
void		print_hd(t_flag *flag, int *r)
{
	char	*arr;
	int		i;
	int		nb;
