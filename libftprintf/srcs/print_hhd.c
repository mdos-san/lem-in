...
/*   Updated: 2016/10/22 06:08:47 by mdos-san         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	get_width(t_flag *flag, char *arr, int *nb, char in)
{
	*nb = 0;
...
static void	flag_space(t_flag *flag, char in, int *nb, int *r)
{
